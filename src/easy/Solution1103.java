 ...
 * @Package: easy
 * @Author: YY
 * @CreateTime: 2024-06-03  16:39
 * @Description: Solution1103
 * 1103. 分糖果 II
 * 简单
 * 相关标签
 * 相关企业
...
public class Solution1103 {
    ...
    public static int[] distributeCandies(int candies, int num_people) {
        ...
        while (residual > 0) {
            ...
            //剩余的是不是大于接下来分配的
            results[index % num_people] = residual > distribution ? (results[index % num_people] + distribution) : (results[index % num_people] + residual);
